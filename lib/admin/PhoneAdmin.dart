...
class PhoneAdmin extends StatefulWidget {
  const PhoneAdmin({super.key});

  @override
  State<PhoneAdmin> createState() => _PhoneAdminState();
}

class _PhoneAdminState extends State<PhoneAdmin> {
  @override
  File? file;
  String? url;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Phone Admin",style: TextStyle(color: Colors.white),),
